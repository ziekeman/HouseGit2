      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="order-last lg:order-last relative w-full lg:h-[700px] flex items-center justify-center">
            ...
            <div className="absolute -bottom-4 right-4 lg:bottom-8 lg:-left-16 w-32 lg:w-64 aspect-square rounded-[1rem] lg:rounded-[1.5rem] overflow-hidden shadow-lg border-4 lg:border-[6px] border-white">
