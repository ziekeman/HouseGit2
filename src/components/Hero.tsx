      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-start">
          ...
          <div className="flex flex-col justify-center lg:pt-16">
            ...
            {/* Description */}
            <p className="text-foreground/80 text-base lg:text-lg leading-relaxed max-w-md mb-6 font-body">
            ...
            {/* CTA Button */}
            <button onClick={scrollToContact} className="inline-flex items-center gap-3 bg-[#262626] text-white px-6 py-4 rounded-full font-display font-medium text-sm w-fit hover:opacity-90 transition-opacity group">
              GET IN TOUCH
          ...
          <div className="relative lg:h-[700px] flex items-center justify-center">
            ...
            <div className="relative w-full max-w-md lg:max-w-none lg:w-[520px] aspect-[5/6.1] rounded-tl-[6rem] rounded-tr-none rounded-br-none rounded-bl-none overflow-hidden border-[6px] border-white shadow-lg">
              <img src={heroTabitha} alt="Tabitha with balloons" className="w-full h-full object-cover" />
            </div>

            {/* Overlay Image - House of Engagement sign */}
            <div className="absolute -bottom-8 -left-8 lg:bottom-8 lg:-left-16 w-52 lg:w-64 aspect-square rounded-[1.5rem] overflow-hidden shadow-lg border-[6px] border-white">
