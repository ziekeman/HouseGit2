        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="order-last lg:order-last relative w-full lg:h-[700px] flex items-center justify-center">
            ...
            <AnimatedSection animation="scale-up" delay={200}>
              <div className="relative w-[85%] lg:w-[520px] aspect-square lg:aspect-[5/5.5] rounded-[2rem] lg:rounded-[3rem] overflow-hidden shadow-lg mx-auto">
                <img src={heroImage} alt="Hero image" className="w-full h-full object-cover" />
              </div>
            </AnimatedSection>

            {/* Overlay Image - House of Engagement sign */}
            <AnimatedSection animation="slide-right" delay={400} className="absolute -bottom-1 left-[5px] lg:bottom-28 lg:-left-16">
              <div className="w-[26px] lg:w-[205px] h-[38px] lg:h-[307px] rounded-[1rem] lg:rounded-[1.5rem] overflow-hidden shadow-lg">
          ...
          <div className="order-first lg:order-first flex flex-col justify-center lg:pt-16">
            {/* Main Headline */}
            <h1 className="font-agrandir text-[2.8rem] sm:text-7xl lg:text-8xl font-extrabold text-primary leading-[0.9] mb-2 px-[5px] lg:px-0 tracking-[-0.08em]">
