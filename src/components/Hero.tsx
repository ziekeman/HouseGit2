      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="order-last lg:order-last relative w-full lg:h-[700px] flex items-center justify-center">
            ...
            <div className="relative w-[85%] lg:w-[520px] aspect-square lg:aspect-[5/6.1] rounded-tl-[4rem] lg:rounded-tl-[6rem] rounded-tr-none rounded-br-none rounded-bl-none overflow-hidden border-4 lg:border-[6px] border-white shadow-lg">
              <img src={heroTabitha} alt="Tabitha with balloons" className="w-full h-full object-cover" />
            </div>

            {/* Overlay Image - House of Engagement sign */}
            <div className="absolute -bottom-4 left-[5px] lg:bottom-8 lg:-left-16 w-32 lg:w-64 aspect-square rounded-[1rem] lg:rounded-[1.5rem] overflow-hidden shadow-lg border-4 lg:border-[6px] border-white">
          ...
          <div className="order-first lg:order-first flex flex-col justify-center lg:pt-16">
            ...
            {/* Trusted By */}
            <div className="mt-6 lg:mt-10 scale-[0.85] lg:scale-100 origin-center lg:origin-left flex flex-col items-center lg:items-start">
