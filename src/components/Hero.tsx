      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-start">
          ...
          <div className="relative lg:h-[700px] flex items-center justify-center">
            ...
            <div className="relative w-full max-w-md lg:max-w-none lg:w-[520px] aspect-[3/4] rounded-tl-[6rem] rounded-tr-none rounded-br-none rounded-bl-none overflow-hidden border-[6px] border-white shadow-lg">
